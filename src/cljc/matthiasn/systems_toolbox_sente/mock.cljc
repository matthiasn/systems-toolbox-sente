(ns matthiasn.systems-toolbox-sente.mock
  "This namespace contains a component that can be used on to mock WebSockets communication."
...
(defn cmp-map
  "Returns map for creating server-side WebSockets communication component. Takes the cmp-id and
  a configuration map."
  {:added "0.5.4"}
  [cmp-id cfg]
  {:cmp-id           cmp-id
